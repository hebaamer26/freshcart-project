    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-6 py-8">
        ...
        {numOfCartItems > 0 ? (
          ...
          <div className="bg-[#FAFAFA] rounded-2xl p-12 text-center max-w-2xl mx-auto mt-8">
            <div className="w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-6">
              <BsTruck className="w-10 h-10 text-orange-400" />
            </div>
            <h2 className="text-2xl font-semibold mb-3 text-gray-800">Your cart is empty</h2>
            <p className="text-gray-500 mb-8 max-w-md mx-auto">
              You haven't added any products to your cart yet. Add some items to proceed to checkout!
            </p>
            <Link
              href="/allProducts"
              className="inline-block bg-[#FF7A00] hover:bg-[#E66D00] text-white py-3 px-8 rounded-xl transition-colors font-medium"
            >
              Start Shopping
            </Link>
          </div>
