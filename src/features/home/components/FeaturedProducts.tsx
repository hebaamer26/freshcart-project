      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-3 lg:px-8 ">
        <div className="max-w-9xl mx-auto">
          ...
          <div className="flex items-center gap-3 my-8 mb-13">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 ">Featured <span className="text-orange-400">Products</span></h2>
          </div>
          {/* Products */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-items-center sm:justify-items-stretch">
